...
const initialNotifications: Notification[] = [
  {
    ...
    message:
      "Tu adelanto de salario ha sido depositado exitosamente en tu cuenta. El monto ya está disponible para su uso.",
    date: "13 Ene 2026",
    time: "10:30 AM",
    isRead: false,
    details: {
      amount: 800,
      reference: "TRX-2026-001847",
      account: "BCP ****1234",
    },
  },
  {
    ...
    message:
      "No pudimos procesar tu desembolso debido a un error técnico en el sistema de pagos. Por favor, intenta nuevamente más tarde.",
    date: "12 Ene 2026",
    time: "3:45 PM",
    isRead: false,
    details: {
      amount: 1200,
      reference: "TRX-2026-001832",
      account: "BCP ****1234",
    },
  },
  {
    ...
    message:
      "Tu solicitud de préstamo personal no ha sido aprobada. El motor de decisión ha determinado que no cumples con los requisitos necesarios en este momento.",
    date: "10 Ene 2026",
    time: "11:20 AM",
    isRead: true,
    details: {
      amount: 2500,
      reference: "SOL-2026-000412",
    },
  },
  {
    id: "4",
    ...
    message:
      "¡Felicitaciones! Tu préstamo personal ha sido aprobado y el desembolso se realizará en las próximas 24 horas.",
    date: "05 Ene 2026",
    time: "9:15 AM",
    isRead: true,
    details: {
      amount: 1500,
      reference: "PRE-2026-000089",
      account: "BCP ****1234",
    },
  },
]
